...
export const detailsRcp = () => {
  ...
  <div class="contendor">
    ...
    <div class="contenedor">
      ...
      <div class="check"> 
        <div>
        <p class="text-ingredient">Para la masa<p/>  
        </div>     
        ...
        <br>
        <input type="checkbox" class="check" value="">150g de pepperoni.
        <br>
        <input type="checkbox" class="check" value="">Orégano seco.
      </div>
    </div>
    <div class="contenedor">
      <div>
      ...
      <div>
        ...
        <div class= "container-title">
         <h6> Ahora a disfrutar de tu pizza 🍕</h6>
        </div>
    </div>`;
