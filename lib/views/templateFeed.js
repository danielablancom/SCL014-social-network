      ...
      <div id="post-rct" class="container2">
        <div class="post">
          ...
          <div>
            ...
            <button class="btn-like"><i class="far fa-heart icon-feed2 heart" index="${index}"></i></button>
          <div class="container3">
            <img class="user-img" src='${receipe.foto ? receipe.foto : '../img/iconos/cook.jpg'}'>
          ...
          <div class="follow-divbutton">
            ...
            <a class="details-rcp" href="#/detailsRcp"><strong>Leer más...</strong></a>
          </div> 
        </div>
      </div>`;
